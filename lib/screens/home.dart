...
import 'package:todo/widgets/login_register_warning.dart';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: Obx(
          () => IconButton(
            onPressed: () async {
              if (userController.authState.value) {
            ...
            icon: Icon(userController.authStateIcon.value),
          ),
        ),
        title: Text(
          'ToDo List',
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          if (FirebaseAuth.instance.currentUser == null) {
            Get.dialog(const LoginRegisterWarning());
